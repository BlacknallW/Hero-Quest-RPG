...
class Character:
    def __init__(self, name, power, health, stats):
        self.name = name
        self.power = power
        self.health = health
        self.stats = stats
...
hero = Hero("Maximo", 5, 100, {"Strength" : 5, "Agility": 5, "Constitution": 5})
goblin = Character("Goblin", 2, , {"Strength" : 5, "Agility": 7, "Constition": 5})
